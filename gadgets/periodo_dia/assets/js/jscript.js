...
function fHoraAtual() {
    ...
    if (Number(sHraAtu) < 12) {
        ...
        oImgAtu.innerHTML = `<img src="./assets/body_img/img_amanhecer.png" alt="Amanhecer">`
        ...
        oImgAtu.innerHTML = `<img src="./assets/body_img/img_entardecer.png" alt="Entardecer">`
        ...
        oImgAtu.innerHTML = `<img src="./assets/body_img/img_anoitecer.png" alt="Anoitecer">`
